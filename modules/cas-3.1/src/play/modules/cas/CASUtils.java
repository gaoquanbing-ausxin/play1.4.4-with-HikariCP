...
public class CASUtils {
    ...
    public static String getCasLoginUrl(Boolean possibleGateway) {
        ...
        Boolean isMultipleDomainSupport = Boolean.valueOf(
                                            Play.configuration.getProperty("multiple.domain.support"));
        ...
        if (isCasMockServer()) {
            ...
            if (isMultipleDomainSupport) {

                String currentDomain = Http.Request.current().domain;
                if (currentDomain.endsWith(".corp")) {
                    casLoginUrl = Play.configuration.getProperty("inner.cas.loginUrl");
                }
    ...
    public static String getCasLogoutUrl() {
        ...
        if (isCasMockServer()) {
            ...
            if (isMultipleDomainSupport) {
                ...
                if (currentDomain.endsWith(".corp")) {
                    return Play.configuration.getProperty("inner.cas.logoutUrl");
                }
                else {
    ...
    private static String getCasServiceValidateUrl() {
        ...
        if (isCasMockServer()) {
            ...
            if (isMultipleDomainSupport) {
                ...
                if (currentDomain.endsWith(".corp")) {
                    casServiceValidateUrl = Play.configuration.getProperty("inner.cas.validateUrl");
                }
                else {
